  ...
  fluidRow(
    ...
    column(
      ...
      p("This cluster plot groups watersheds based on shared fish fauna. 
        Compare the clusters to the watershed map below. Notice the upper
        most cluster contains the Milk, the Lower Yellowstone, and the Lower
        Missouri watersheds. These three watersheds share many of the same species."),
      p("The next cluster down has the Musselshell, Upper Yellowstone, and Bighorn
        watersheds, again based on similarity of the fish fauna. This cluster is in
        a larger cluster with the Milk, Lower Yellowstone, and Lower Missouri. 
        This makes biogeographic sense because these watersheds are all in the
        plains of Montana."),
      p("As you might have predicted, the Kootenai and Clark Fork watersheds
        cluster together because they are western slope watersheds and thus have
        a high faunal similarity.", strong("But what is up with the Saskatchewan and
        Upper Missouri watersheds?"), "Did you predict these eastern slope 
        watersheds to be similar to the western slope watersheds?"),
      p("The Saskatchewan and Upper Missouri watersheds have lower similarity to
        ...
        em("somewhere."), "(By the way, the vertical arrangement of the labels is
        arbitrary. For example, the cluster with the Kootenai and Clark Fork
        watersheds could be the uppermost cluster, followed by the cluster with
        the Saskatchewan and Upper Missouri. Similarity is conveyed", em("only"), 
        "by the branching pattern."),
