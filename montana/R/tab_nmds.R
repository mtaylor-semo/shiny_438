  ...
  fluidRow(
    ...
    column(
      ...
      p("This scatterplot is the result of a non-metric multidimensional scaling
        ...
        similarity. Less similar watersheds are farther apart. (The left-to-right
        or lower-to-upper directions on the x- and y-axes are meaningless. The
        plot could be flipped in both directions but the interpretation is the
        same."),
      p("You can see the high similarity of the Milk, Lower Yellowstone, and
        ...
        Fork watersheds. (It's not common to have watersheds with exactly the same
        species but Montana does not have very many species of fishes."),
      p("This plot shows the clear differences of the Saskatchewan and Upper
        Missouri Rivers from each other and from the other watersheds. The Upper
        Missouri is about as different from the Upper Yellowstone and Bighorn
        as these two are from the Lower Yellowstone, Lower Missouri, and Milk."),
