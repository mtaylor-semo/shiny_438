...
```{r fig.dim=c(6.5,4), echo=FALSE, fig.cap=paste("Histogram of North American", input$na_taxon, "for geographic range size."), fig.align='left'}
plots$na
```
...
```{r fig.dim=c(6.5,4), echo=FALSE, fig.cap=paste("Histogram of", input$state, input$taxon, "for geographic range size."), fig.align='left'}
plots$state
```
...
```{r fig.dim=c(6.5,4), echo=FALSE, fig.cap=paste("Bar chart of species richness of", input$rapo_taxon, "for five states"), fig.align='left'}
plots$rapo
```
