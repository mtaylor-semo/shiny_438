...
\textbf{You predicted} “`r input$predict_pc`”
...
\textbf{You explained} “`r input$pc_result`”

\end{multicols}
\end{enumerate}


```{r fig.dim=c(6.5,4), echo=FALSE, fig.cap="Histogram of California Marine Fishes for geographic range size.", fig.align='left'}
plots$pc
```
